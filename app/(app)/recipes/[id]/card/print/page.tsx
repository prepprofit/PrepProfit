        ...
        >
          ...
          <div className="flex items-start justify-between gap-6">
            ...
            <div className="flex flex-col items-end gap-0.5">
              <span className="text-xl font-bold tracking-wide text-[#096567]">
                {labels.title}
              </span>
              <span className="text-base font-semibold text-neutral-900">
                {data.recipeName}
              ...
              {data.scale && (
                <span className="font-semibold text-[#096567]">
                  {labels.scaledTo({
          ...
          <div className="ml-auto mt-6 flex w-64 flex-col gap-1">
            ...
            {data.marginPercent != null && (
              <div className="mt-1 flex justify-between font-semibold text-[#096567]">
